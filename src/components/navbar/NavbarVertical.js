...
import { getProfile, getToken } from '../../services/storages/userStorage';
import { Redirect } from 'react-router-dom';


const usersRoutesFake = [
  {
    name: 'Users',
    to: '/users',
    icon: 'copy',
    children: [{ to: '/users', name: 'List' }]
  },
  {
    name: 'Badge',
    to: '/badge',
  ...
  return (
    ...
    >
      ...
      >
        <Nav navbar vertical>
          {profile?.roles === 'ADMIN' ? (
            <NavbarVerticalMenu routes={usersRoutesFake} />
          ) : (
